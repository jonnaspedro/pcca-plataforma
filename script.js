...
// ==================== INDEX.HTML ====================
// Exibir todas as perguntas na página inicial
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (!loginSalvo) {
        // Substitui a área do formulário por mensagem
    ...
    // Se estiver logado, preenche o nome automaticamente
...
// Inicializa os conteúdos ao carregar a página
